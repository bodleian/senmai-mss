...
./generate-html.sh && ./generate-solr-document.sh manuscripts.xquery manuscripts_index.xml manuscript solr01-prd.bodleian.ox.ac.uk $1

# Reindex works
./generate-solr-document.sh works.xquery works_index.xml work solr01-prd.bodleian.ox.ac.uk $1

# Reindex people
./generate-solr-document.sh persons.xquery persons_index.xml person solr01-prd.bodleian.ox.ac.uk $1
